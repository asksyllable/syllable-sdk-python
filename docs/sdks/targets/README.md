...
with SyllableSDK(
    ...
    res = ss_client.channels.targets.create(channel_id_param=134365, agent_id=486589, channel_id=638424, target="<value>", target_mode=syllable_sdk.TargetModes.CHAT)
