...
| `order_by`                                                                                                                                             | [OptionalNullable[models.UserProperties]](../../models/userproperties.md)                                                                              | :heavy_minus_sign:                                                                                                                                     | The field whose value should be used to order the results                                                                                              |                                                                                                                                                        |
...
with SyllableSDK(
    ...
    res = ss_client.v1.users_send_email(user_email="<value>")
