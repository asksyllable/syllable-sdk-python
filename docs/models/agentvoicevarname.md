...
| `WAVENET_FEMALE_ES_US_CHIRP3_HD_CALLIRRHOE`    | wavenet:female/es-US-Chirp3-HD-Callirrhoe      |
| `WAVENET_FEMALE_TH_TH_CHIRP3_HD_CALLIRRHOE`    | wavenet:female/th-TH-Chirp3-HD-Callirrhoe      |
...
| `WAVENET_FEMALE_ES_US_CHIRP3_HD_VINDEMIATRIX`  | wavenet:female/es-US-Chirp3-HD-Vindemiatrix    |
| `WAVENET_FEMALE_TH_TH_CHIRP3_HD_VINDEMIATRIX`  | wavenet:female/th-TH-Chirp3-HD-Vindemiatrix    |
...
| `CARTESIA_SKYLAR`                              | cartesia:Skylar                                |
| `CARTESIA_DANIEL`                              | cartesia:Daniel                                |
| `CARTESIA_LINDA`                               | cartesia:Linda                                 |
| `CARTESIA_COREY`                               | cartesia:Corey                                 |
| `CARTESIA_EMMA`                                | cartesia:Emma                                  |
| `CARTESIA_XIMENA`                              | cartesia:Ximena                                |
| `CARTESIA_FERNANDA`                            | cartesia:Fernanda                              |
| `CARTESIA_EMILIO`                              | cartesia:Emilio                                |
| `CARTESIA_MARTA`                               | cartesia:Marta                                 |
| `CARTESIA_MATEO`                               | cartesia:Mateo                                 |
| `CARTESIA_MINJI`                               | cartesia:Minji                                 |
| `CARTESIA_HAEUN`                               | cartesia:Haeun                                 |
| `CARTESIA_TAEHYUN`                             | cartesia:Taehyun                               |
| `CARTESIA_JAEWON`                              | cartesia:Jaewon                                |
| `CARTESIA_HUA`                                 | cartesia:Hua                                   |
| `CARTESIA_LIU`                                 | cartesia:Liu                                   |
| `CARTESIA_XIA`                                 | cartesia:Xia                                   |
| `CARTESIA_SUDA`                                | cartesia:Suda                                  |