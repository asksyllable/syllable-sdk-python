...
class Agents(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        search_fields: Optional[Iterable[models.AgentProperties]] = None,
        ...
        fields: OptionalNullable[Iterable[models.AgentProperties]] = UNSET,
        ...
        request = models.AgentListRequest(
            ...
            search_fields=utils.unmarshal(
                search_fields, Optional[List[models.AgentProperties]]
            ),
            ...
            fields=utils.unmarshal(
                fields, OptionalNullable[List[models.AgentProperties]]
            ),
        ...
        *,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="agent_list_active_labels",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
    ...
    async def agent_list_active_labels_async(
        self,
        *,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
    ...
    def agent_get_available_voices(
        self,
        *,
        selected_voice: OptionalNullable[Iterable[str]] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
        ...
        request = models.AgentGetAvailableVoicesRequest(
            selected_voice=utils.unmarshal(selected_voice, OptionalNullable[List[str]]),
        )
    ...
    def agent_get_available_stt_providers(
        self,
        *,
        selected_provider: OptionalNullable[str] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> List[models.SupportedSttProvider]:
        r"""Get Available Agent Stt Providers
        ...
        request = models.AgentGetAvailableSttProvidersRequest(
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="agent_get_available_stt_providers",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(List[models.SupportedSttProvider], http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.HTTPValidationErrorData, http_res
            )
    ...
    async def agent_get_available_stt_providers_async(
        self,
        *,
        selected_provider: OptionalNullable[str] = UNSET,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
    ...
    def post_card_click_event(
        self,
        *,
        test_id: str,
        card_click_request: Union[
            models.CardClickRequest, models.CardClickRequestTypedDict
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.CardClickResponse:
        r"""Create Card Click Event

        Log an EventLog for a client-side card click interaction.

        :param test_id:
        :param card_click_request:
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        request = models.PostCardClickEventRequest(
            test_id=test_id,
            card_click_request=utils.get_pydantic_model(
                card_click_request, models.CardClickRequest
            ),
        )
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.card_click_request,
                False,
                False,
                "json",
                models.CardClickRequest,
            ),
            allow_empty_value=None,
            timeout_ms=timeout_ms,
        )
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="post_card_click_event",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.CardClickResponse, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.HTTPValidationErrorData, http_res
            )
    ...
    async def post_card_click_event_async(
        self,
        *,
        test_id: str,
        card_click_request: Union[
