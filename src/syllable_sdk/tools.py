...
class Tools(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        search_fields: Optional[Iterable[models.ToolProperties]] = None,
        ...
        fields: OptionalNullable[Iterable[models.ToolProperties]] = UNSET,
        ...
        request = models.ToolListRequest(
            ...
            search_fields=utils.unmarshal(
                search_fields, Optional[List[models.ToolProperties]]
            ),
            ...
            fields=utils.unmarshal(
                fields, OptionalNullable[List[models.ToolProperties]]
            ),
    ...
    def tool_history(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ListResponseToolHistoryResponse:
        r"""Tool History
        ...
        request = models.ToolHistoryRequest(
            tool_id=tool_id,
            page=page,
            limit=limit,
            order_by_direction=order_by_direction,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(
                models.ListResponseToolHistoryResponse, http_res
            )
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.HTTPValidationErrorData, http_res
