...
class Workflows(BaseSDK):
    ...
    def insights_workflow_files(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> models.ListResponseWorkflowFileRow:
        r"""List Insight Workflow Files
        ...
        request = models.InsightsWorkflowFilesRequest(
            workflow_id=workflow_id,
            page=page,
            limit=limit,
            search_fields=utils.unmarshal(search_fields, Optional[List[str]]),
        ...
        req = self._build_request(
            method="GET",
            path="/api/v1/insights/workflows/{workflow_id}/files",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                config=self.sdk_configuration,
                base_url=base_url or "",
                operation_id="insights_workflow_files",
                oauth2_scopes=None,
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return unmarshal_json_response(models.ListResponseWorkflowFileRow, http_res)
        if utils.match_response(http_res, "422", "application/json"):
            response_data = unmarshal_json_response(
                errors.HTTPValidationErrorData, http_res
            )
    ...
    async def insights_workflow_files_async(
        self,
        *,
        workflow_id: int,
        page: OptionalNullable[int] = UNSET,
