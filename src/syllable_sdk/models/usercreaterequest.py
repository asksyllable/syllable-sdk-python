...
class UserCreateRequestTypedDict(TypedDict):
    ...
    utm: NotRequired[Nullable[DaoUtmTypedDict]]
    r"""Optional UTM campaign attribution to record in user_metadata."""
...
class UserCreateRequest(BaseModel):
    ...
    utm: OptionalNullable[DaoUtm] = UNSET
    r"""Optional UTM campaign attribution to record in user_metadata."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(
            ["first_name", "last_name", "utm", "login_type", "skip_auth"]
        )
        nullable_fields = set(["first_name", "last_name", "utm", "login_type"])
