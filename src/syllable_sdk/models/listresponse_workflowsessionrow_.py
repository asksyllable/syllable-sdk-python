...
from .workflowsessionrow import WorkflowSessionRow, WorkflowSessionRowTypedDict
...
class ListResponseWorkflowSessionRowTypedDict(TypedDict):
    items: List[WorkflowSessionRowTypedDict]
...
class ListResponseWorkflowSessionRow(BaseModel):
    items: List[WorkflowSessionRow]
    r"""List of items returned from the query"""
