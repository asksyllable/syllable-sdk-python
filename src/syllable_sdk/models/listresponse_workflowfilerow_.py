...
class ListResponseWorkflowFileRowTypedDict(TypedDict):
    items: List[WorkflowFileRowTypedDict]
...
class ListResponseWorkflowFileRow(BaseModel):
    items: List[WorkflowFileRow]
    r"""List of items returned from the query"""
