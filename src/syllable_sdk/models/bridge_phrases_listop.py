...
class BridgePhrasesListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[BridgePhrasesProperties]]
    ...
    fields: NotRequired[Nullable[List[BridgePhrasesProperties]]]
...
class BridgePhrasesListRequest(BaseModel):
    page: Annotated[
    ...
    search_fields: Annotated[
        Optional[List[BridgePhrasesProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[BridgePhrasesProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[BridgePhrasesProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
