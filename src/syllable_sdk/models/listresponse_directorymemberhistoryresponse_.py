...
class ListResponseDirectoryMemberHistoryResponseTypedDict(TypedDict):
    items: List[DirectoryMemberHistoryResponseTypedDict]
...
class ListResponseDirectoryMemberHistoryResponse(BaseModel):
    items: List[DirectoryMemberHistoryResponse]
    r"""List of items returned from the query"""
