...
class AgentVoiceVarName(str, Enum):
    ...
    WAVENET_FEMALE_AR_XA_CHIRP3_HD_CALLIRRHOE = (
        "wavenet:female/ar-XA-Chirp3-HD-Callirrhoe"
    )
    WAVENET_FEMALE_FR_FR_CHIRP3_HD_CALLIRRHOE = (
        "wavenet:female/fr-FR-Chirp3-HD-Callirrhoe"
    )
    WAVENET_FEMALE_JA_JP_CHIRP3_HD_CALLIRRHOE = (
    ...
    WAVENET_FEMALE_AR_XA_CHIRP3_HD_VINDEMIATRIX = (
        "wavenet:female/ar-XA-Chirp3-HD-Vindemiatrix"
    )
    WAVENET_FEMALE_FR_FR_CHIRP3_HD_VINDEMIATRIX = (
        "wavenet:female/fr-FR-Chirp3-HD-Vindemiatrix"
    )
    WAVENET_FEMALE_JA_JP_CHIRP3_HD_VINDEMIATRIX = (
