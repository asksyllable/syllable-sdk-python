...
class InsightsWorkflowExecutionsOrderBy(str, Enum):
...
class InsightsWorkflowExecutionsRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[InsightsWorkflowExecutionsOrderBy]]
    r"""The field whose value should be used to order the results"""
    order_by_direction: NotRequired[Nullable[OrderByDirection]]
    r"""The direction in which to order the results"""
    fields: NotRequired[Nullable[List[FieldT]]]
...
class InsightsWorkflowExecutionsRequest(BaseModel):
    ...
    order_by: Annotated[
        OptionalNullable[InsightsWorkflowExecutionsOrderBy],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
