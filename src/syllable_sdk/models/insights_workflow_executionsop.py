...
class InsightsWorkflowExecutionsRequestTypedDict(TypedDict):
    workflow_id: int
    ...
    order_by: NotRequired[Nullable[InsightWorkflowExecutionProperties]]
    ...
    fields: NotRequired[Nullable[List[InsightWorkflowExecutionProperties]]]
...
class InsightsWorkflowExecutionsRequest(BaseModel):
    ...
    order_by: Annotated[
        OptionalNullable[InsightWorkflowExecutionProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[InsightWorkflowExecutionProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
