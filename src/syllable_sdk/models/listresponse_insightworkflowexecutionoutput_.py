...
class ListResponseInsightWorkflowExecutionOutputTypedDict(TypedDict):
    items: List[InsightWorkflowExecutionOutputTypedDict]
...
class ListResponseInsightWorkflowExecutionOutput(BaseModel):
    items: List[InsightWorkflowExecutionOutput]
    r"""List of items returned from the query"""
