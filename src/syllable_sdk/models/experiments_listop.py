...
class ExperimentsListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[ExperimentProperties]]
    ...
    fields: NotRequired[Nullable[List[ExperimentProperties]]]
...
class ExperimentsListRequest(BaseModel):
    page: Annotated[
    ...
    search_fields: Annotated[
        Optional[List[ExperimentProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[ExperimentProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[ExperimentProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
