...
from .bridgephrasesresponse import BridgePhrasesResponse, BridgePhrasesResponseTypedDict
...
class ListResponseBridgePhrasesResponseTypedDict(TypedDict):
    items: List[BridgePhrasesResponseTypedDict]
...
class ListResponseBridgePhrasesResponse(BaseModel):
    items: List[BridgePhrasesResponse]
    r"""List of items returned from the query"""
