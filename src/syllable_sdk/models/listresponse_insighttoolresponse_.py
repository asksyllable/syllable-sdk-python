...
class ListResponseInsightToolResponseTypedDict(TypedDict):
    items: List[InsightToolResponseTypedDict]
...
class ListResponseInsightToolResponse(BaseModel):
    items: List[InsightToolResponse]
    r"""List of items returned from the query"""
