...
class TelephonyConfigurationsTypedDict(TypedDict):
    ...
    sip_configuration: NotRequired[Nullable[SipConfigurationTypedDict]]
    r"""SIP routing configuration applied when transferring calls on this channel"""
...
class TelephonyConfigurations(BaseModel):
    ...
    sip_configuration: OptionalNullable[SipConfiguration] = UNSET
    r"""SIP routing configuration applied when transferring calls on this channel"""
