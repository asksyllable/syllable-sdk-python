...
class BridgePhrasesUpdateRequestTypedDict(TypedDict):
    r"""Request model to update an existing bridge phrases config."""
...
class BridgePhrasesUpdateRequest(BaseModel):
    r"""Request model to update an existing bridge phrases config."""
