...
[`SyllableSDKError`](./src/syllable_sdk/models/syllablesdkerror.py) is the base class for all HTTP error responses. It has the following properties:
...
### Error Classes
**Primary errors:**
* [`SyllableSDKError`](./src/syllable_sdk/models/syllablesdkerror.py): The base class for HTTP error responses.
  * [`HTTPValidationError`](./src/syllable_sdk/models/httpvalidationerror.py): Validation Error. Status code `422`. *
...
**Inherit from [`SyllableSDKError`](./src/syllable_sdk/models/syllablesdkerror.py)**:
* [`ResponseValidationError`](./src/syllable_sdk/models/responsevalidationerror.py): Type mismatch between the response data and the expected Pydantic model. Provides access to the Pydantic validation error via the `cause` attribute.
